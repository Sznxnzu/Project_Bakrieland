...
<style>
  ...
  .mood-box-content h2 {
    font-size:45px; margin-bottom:.5em;
  }
  ...
  /*―――――― OVERRIDE CONTAINER CAMERA ――――――*/
  /* buang background/card default Streamlit */
  ...
  /* jika ada div children lain, juga transparan */
