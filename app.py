...
with col_header_right:
    ...
    <div style="position: absolute; top: -30px; right: -100px;">
        ...
        <div style="font-size: 11px; color: #ccc;">
            ...
            <img src="https://raw.githubusercontent.com/Sznxnzu/Project_Bakrieland/main/resources/logo/google_logo.png" style="height: 40px; vertical-align: middle; margin-left: 4px; margin-right: -30px;" />
