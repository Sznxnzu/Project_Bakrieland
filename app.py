...
<style>
  ...
  /*――――― HEADER BOX ―――――*/
  .header-box { /* … sama seperti sebelumnya … */ }

  /*――――― PORTRAIT & MOOD BOX ―――――*/
  .portrait-box, .mood-box-content { /* … sama seperti sebelumnya … */ }

  /*――――― SIDEBAR LOGOS ―――――*/
  .column-wrapper, .logo-box, .mascot-box { /* … sama seperti sebelumnya … */ }

  /*――――― OVERRIDE FILE UPLOADER (Take Photo card) ―――――*/
  ...
  @media (max-width: 768px) {
    div[data-testid="stFileUploader"] { margin-top: 90px; }
    div[data-testid="stCameraInputWebcamStyledBox"] {
